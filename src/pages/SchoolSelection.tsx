    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          {schools.length === 0 ? (
            <div className="rounded-2xl border border-border bg-card p-12 text-center max-w-md mx-auto shadow-sm">
                  ...
                  >
                    ...
                    <div className="mb-4">
                      {school.logoUrl ? (
                        ...
                        <div
                          className="h-16 w-16 rounded-xl flex items-center justify-center border border-border transition-colors group-hover:border-primary/30"
                          style={{ backgroundColor: (school.themeColor || '#3B82F6') + '10' }}
                        >
                          <Building2
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-foreground">EduReport</span>
            </div>
